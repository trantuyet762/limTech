...
<section class="gioithieu mt-[1.5625rem] sm:mt-[2.5rem]">
    <div class="container">
        <div>
            ...
            <div class="mt-[1.75rem] sm:mt-[2.5rem] gioithieu_sub-content-container">
                <h2 class="gioithieu_sub-content"><span>Lintimate</span> - nâng cao sức khỏe phụ nữ</h2>
                <div></div>
            </div>
            <div class="gioithieu_main-content mt-[1.25rem]">
                <h1>VỀ LINTIMATE</h1>
                <div></div>
            </div>
        </div>
