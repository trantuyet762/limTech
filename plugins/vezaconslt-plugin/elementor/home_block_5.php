...
class Home_Block_5 extends Widget_Base
{
    public function get_name()
    {
        return 'vezaconslt_home_block_5';
    }

    public function get_title()
    {
        return esc_html__('Khối 5', 'vezaconslt');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'home_block_5_start',
            [
                'label' => esc_html__('Khối 5', 'vezaconslt'),
            ]
        );
        $this->add_control(
            'category',
            ...
            <div class="container">
                ...
                <div class="flex flex-wrap -mx-2.5 gap-y-5">
                    <div class="w-full lg:w-3/4 px-2.5">
                        <div class="lg:border-r lg:border-cl-main lg:pr-5">
                            <div class="flex flex-wrap -mx-2.5 gap-y-5 mb-5">
                                <div class="w-full md:w-2/3 px-2.5">
                                    <a href="<?php echo get_the_permalink($posts[0]->ID); ?>" class="c-img pt-[56.5%] grow img__ block rounded-[5px] overflow-hidden">
                                        <img src="<?php echo get_the_post_thumbnail_url($posts[0]->ID, 'medium'); ?>" alt="">
                                    </a>
                                </div>
                                <div class="w-full md:w-1/3 px-2.5 md:-order-1">
                                    <h3 class="mb-4">
                                    ...
                                    <div class="w-full md:w-1/2 lg:w-1/4 px-2.5">
                                        <div class="flex md:flex-col">
                                            <div class="w-[143px] max-md:mr-3 shrink-0 md:w-full">
                                                <a href="<?php echo get_the_permalink($post->ID); ?>" class="c-img pt-[63.7%] md:pt-[69%] img__ md:mb-4 block rounded-[5px] overflow-hidden">
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex justify-between items-center font-roboto opacity-70 text-[0.75rem] md:text-[0.875rem] lg:text-[1rem]">
                                                    ...
                                                    <div class="flex items-center gap-x-0.5">
                                                        <span class="w-[16px] md:w-[20px] -translate-y-[1px]">
                    ...
                    <div class="w-full lg:w-1/4 px-2.5">
                        <?php foreach (array_slice($posts, 5, 5) as $post): ?>
                            <div class="mb-3 last:mb-0 pb-3 last:pb-0 border-b border-[rgba(38,38,38,0.2)] last:border-none">
                                <h3 class="mb-2">
                                    <a href="<?php echo get_the_permalink($post->ID); ?>" class="line-clamp-3 font-bold hover:text-cl-primary" title="<?php echo $post->post_title; ?>">
                                        <?php echo $post->post_title; ?>
                                    </a>
                                </h3>
                                <div class="s-content line-clamp-2 font-roboto text-[0.875rem]">
