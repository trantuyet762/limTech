...
class Lecturer extends Post_Type
{
    protected $post_type = 'lecturer';
    ...
    {
        self::instance()->menu_name = esc_html__('Giảng viên', 'vezaconslt');
        self::instance()->singular  = esc_html__('Giảng viên', 'vezaconslt');
        self::instance()->plural    = esc_html__('Giảng viên', 'vezaconslt');
        self::instance()->supports    = array('title', 'thumbnail', 'editor');
