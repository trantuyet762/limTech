...
class Faq extends Post_Type {
	...
	public static function init() {
		self::instance()->menu_name = esc_html__( 'Câu hỏi thường gặp', 'vezaconslt' );
		self::instance()->singular  = esc_html__( 'Câu hỏi thường gặp', 'vezaconslt' );
		self::instance()->plural    = esc_html__( 'Câu hỏi thường gặp', 'vezaconslt' );
